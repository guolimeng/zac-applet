...
const _sfc_main = {
  ...
  methods: {
    ...
    getRelative(e, touches) {
      ...
      console.log("x", clientX - this.rect.left);
      console.log("y", clientY - this.rect.top);
    ...
    touchEnd(e) {
      ...
      if (this.chart) {
        ...
        const handler = this.chart.getZr().handler;
        const isClick = Math.abs(touch.x - this.startX) < 10 && new Date() - this.startT < 300;
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/guolimeng/Desktop/work/uni-preset-vue-vite-ts 2/src/components/l-echart/l-echart.vue"]]);
