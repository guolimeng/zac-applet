...
function getDepFromReactive(object3, key) {
  var _a2;
  return (_a2 = targetMap.get(object3)) === null || _a2 === void 0 ? void 0 : _a2.get(key);
}
...
(function(module2, exports2) {
  !function(t2, e2) {
    ...
    var t2 = 1e3, e2 = 6e4, n2 = 36e5, r = "millisecond", i = "second", s2 = "minute", u = "hour", a = "day", o2 = "week", c = "month", f2 = "quarter", h = "year", d2 = "date", l = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M2 = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
      ...
      return { M: c, y: h, w: o2, d: a, D: d2, h: u, m: s2, s: i, ms: r, Q: f2 }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
    }, u: function(t3) {
      return void 0 === t3;
    } }, g = "en", D2 = {};
    D2[g] = M2;
    ...
    var _ = function() {
      ...
      return m3.parse = function(t3) {
        ...
        var n3, o3 = b.p(t3), f3 = "set" + (this.$u ? "UTC" : ""), l2 = (n3 = {}, n3[a] = f3 + "Date", n3[d2] = f3 + "Date", n3[c] = f3 + "Month", n3[h] = f3 + "FullYear", n3[u] = f3 + "Hours", n3[s2] = f3 + "Minutes", n3[i] = f3 + "Seconds", n3[r] = f3 + "Milliseconds", n3)[o3], $2 = o3 === a ? this.$D + (e3 - this.$W) : e3;
        if (o3 === c || o3 === h) {
        ...
        if ($2 === o2)
          return y2(7);
        var M4 = (d3 = {}, d3[s2] = e2, d3[u] = n2, d3[i] = t2, d3)[$2] || 1, m4 = this.$d.getTime() + r2 * M4;
        return b.w(m4, this);
        ...
        var $2, y2 = this, M4 = b.p(d3), m4 = O(r2), v2 = (m4.utcOffset() - this.utcOffset()) * e2, g2 = this - m4, D3 = function() {
          return b.m(y2, m4);
        };
        switch (M4) {
          case h:
    ...
    return O.prototype = k, [["$ms", r], ["$s", i], ["$m", s2], ["$H", u], ["$W", a], ["$M", c], ["$y", h], ["$D", d2]].forEach(function(t3) {
      k[t3[1]] = function(e3) {
